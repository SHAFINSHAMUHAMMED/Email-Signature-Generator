...
export default function temp4({ data }) {
  return (
    <table style={{ fontFamily: 'Arial, sans-serif', color: '#262626', width: '380px', }} cellSpacing="0" cellPadding="0" border="0">
      <tbody>
        <tr style={{display:'flex',gap:'30px', alignItems:'center'}}>
            <td><img height="120" width="120" src={data.profileImage} alt="" /></td>
          <td width="380" style={{display:'flex',flexDirection:'column', alignItems:'center', justifyContent:'center'}}>
              ...
              <tbody>
                <tr>
                  <td style={{ width: '380px' }}>
                    ...
                    <span style={{ fontSize: '14pt',fontWeight:'600', fontFamily: 'Arial, sans-serif', color: '#262626' }}><br />{data.designation}</span>
                  </td>
                </tr>
              </tbody>
            </table>
            <table style={{ width: '380px' }} cellSpacing="0" cellPadding="0">
              <tbody>
                <tr >
                  <td style={{ width: '30px' ,paddingTop:'5px' }}><img src="https://cdn-icons-png.flaticon.com/128/126/126341.png" alt="phone-icon" style={{ border: 0, height: '20px', width: '20px' }} /></td>
                  <td style={{ paddingTop:'5px', width: '160px', fontSize: '13pt', fontWeight:'500', fontFamily: 'Arial, sans-serif', color: '#808080' }}>{data.phone}</td>
                  <td style={{width: '30px',paddingTop:'5px',  }}><img src="https://cdn-icons-png.flaticon.com/128/542/542689.png" alt="mail-icon" style={{ border: 0, height: '20px', width: '20px' }} /></td>
                ...
                <tr>
                  <td style={{paddingTop:'5px', }}><img src="https://cdn-icons-png.flaticon.com/128/1667/1667233.png" alt="website-icon" style={{ border: 0, height: '20px', width: '20px' }} /></td>
